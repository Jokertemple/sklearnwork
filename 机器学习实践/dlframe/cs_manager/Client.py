...
class Client:
    def __init__(self, event_loop, self_addr, host, port=8080, on_connect_callback=None, on_recv_callback=None, on_disconnect_callback=None, on_send_callback=None, on_error_callback=None) -> None:
