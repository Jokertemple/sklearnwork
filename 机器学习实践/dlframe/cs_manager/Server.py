...
class Server:
    def __init__(self, event_loop, self_addr, host='0.0.0.0', port=8080, on_connect_callback=None, on_recv_callback=None, on_disconnect_callback=None, on_send_callback=None, on_error_callback=None) -> None:
